...
final class Cat {
    ...
    public static int sortByBreed(Cat o1, Cat o2){
        return o1.getBreed().toString().compareTo(o2.getBreed().toString());
    }

    public static int sortByName(Cat o1, Cat o2){
        if (o1.name.equals(o2.name))
            return o1.age - o2.age;
        return o1.name.compareTo(o2.name);
    }

    public static boolean isColor(Cat cat){
        return cat.color == Color.SILVER;
    }

    public static boolean isLengthFive(Cat cat){
